...
BToKstll=cms.EDProducer("BToKstllProducer",
                        ...
                        isLeptonElectron = cms.vuint32(0, 0),
                        isLowPtEle = cms.vuint32(0, 0),
                        isLowPtAndPfEle = cms.vuint32(0, 0),
                        isChannelKst = cms.vuint32(0, 0),
                        useLostLeadMuonTracks = cms.vuint32(0, 0),
                        useLostSubLeadLepTracks = cms.vuint32(0, 0),
                        useLostChHadrTracks = cms.vuint32(0, 0),
...
BToKstllTable=cms.EDProducer("SimpleCompositeCandidateFlatTableProducer", 
                             ...
                             variables=cms.PSet(
                                 configuration=Var("userInt('configuration')", int, doc="configuration used to run"),
